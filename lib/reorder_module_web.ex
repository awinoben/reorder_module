defmodule ReorderModuleWeb do
  ...
  def controller do
    quote do
      use Phoenix.Controller, namespace: ReorderModuleWeb
      import Plug.Conn
  ...
  def view do
    quote do
      use Phoenix.View, root: "lib/reorder_module_web/templates",
                        namespace: ReorderModuleWeb
